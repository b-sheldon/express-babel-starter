...
import * as MaxZIndex from './controllers/maxZIndex_controller';
...
io.on('connection', (socket) => {
  ...
  // update maxZIndex
  socket.on('updateMaxZIndex', (maxZIndex) => {
    MaxZIndex.updateMaxZIndex(maxZIndex).then(() => {
      socket.emit('maxZIndex', maxZIndex);
    });
  });
});
